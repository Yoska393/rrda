...
---
title: 'Senario 1 : Cross Validation and Fitting on Simulation Data with RRDA'
output:
...
```{r,eval=F}
plan(multisession)
cv_result<- rrda.cv(Y = Y, X = X,lambda = NULL,maxrank = 10,scale.X = F,scale.Y = F)
plan(sequential)
