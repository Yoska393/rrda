...
fd <- featureData(brge_gexp)
annotation_df <- pData(featureData(brge_gexp))

target_ids <- colnames(B_sub)

matched_annotations <- annotation_df[target_ids, 
    c("gene_assignment", "chromosome", "start", "end", "locus.type")]
```
